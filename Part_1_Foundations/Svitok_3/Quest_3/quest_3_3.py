...
# Мы записываем в переменную путь к нашему артефакту, чтобы заклинания знали, с чем работать.
...
# Результатом является новый, измененный образ, который мы сохраняем в `transformed_image`.
