...
Но на этом сюрпризы не закончились. В других тестах мы столкнулись с не менее удивительным поведением: даже когда «Всевидящее Око» опознавало объект правильно (например, кота), оно давало слишком специфичный ответ — _«египетским котом»_ или даже _«табби»_. А нам ведь нужен был общий ответ — «просто кот».
...
**_А в каких ИИ-инструментах, которыми вы пользуетесь каждый день, вы замечали подобные «слепые зоны» или пробелы в «здравом смысле»?_**
