...
if img is None:
    ...
    # Мы произносим заклинание 'exit()', которое немедленно останавливает выполнение пергамента.
    exit()

# Мы измеряем "сцену", получая высоту, ширину и количество слоев цвета нашего "Актера".
