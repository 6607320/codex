...
Этот пергамент — кульминация "Школы Художников". Его главная цель
(МАКРО-контекст) — провести дообучение (fine-tuning) "Духа-Демиурга"
`Stable Diffusion`, чтобы научить его новому, нашему собственному
художественному стилю.

Мы используем наш собственный "учебник", созданный в предыдущем квесте,
и могущественную магию `LoRA`. Мы "прикрепляем" к сердцу Демиурга (`UNet`)
крошечный "магический блокнот" и обучаем только его. Этот ритуал
демонстрирует, как "впечатать" в гигантскую модель новые визуальные знания,
используя минимальное количество "маны" (VRAM). Мы также осваиваем `accelerate`
— профессиональный инструмент для запуска сложных ритуалов Наставления.
"""
...
palette_dir = "../Quest_1/generated_palette"
