...
- **Проблема обратимых действий:** Рассмотрим два действия: "Открывание двери" и "Закрывание двери". Если проиграть видео открывания двери в обратном порядке, мы получим видео закрывания. Набор кадров (а значит, и набор векторов-эссенций \\{v_1,..., v_T\\}) в обоих случаях идентичен. Следовательно, их среднее арифметическое будет одинаковым: \\frac{1}{T}\\sum v_t. Классификатор, основанный на усреднении, _математически не способен_ различить эти два класса, если они присутствуют в одном датасете.
