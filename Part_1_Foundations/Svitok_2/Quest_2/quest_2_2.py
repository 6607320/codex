...
# нашего "Библиотекаря", который умеет безопасно и эффективно работать с архивами данных.
...
# 5. trust_remote_code=True - Руна Доверия. Мы подтверждаем, что доверяем коду загрузки этого архива.
...
# Руна `device_map="auto"` приказывает амулету автоматически задействовать мощь твоего GPU.
