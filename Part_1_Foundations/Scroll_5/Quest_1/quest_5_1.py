...
Этот пергамент открывает "Школу Наставления". Его главная цель (МАКРО-контекст) —
освоить мудрость экономии при работе с "учебниками" (датасетами), которые могут занимать
сотни гигабайт.

Мы не скачиваем весь архив целиком. Вместо этого мы используем магию потоковой загрузки
(`streaming=True`), чтобы открыть "портал" в Великую Библиотеку и, не загружая всю
книгу, "переписать" из нее лишь небольшой срез данных, достаточный для нашего первого
урока Наставления. Этот квест закрепляет навык работы с большими данными в условиях
