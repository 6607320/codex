...
Далее раскроем три фундаментальных и, возможно, удивительных озарения о том, как устроен PyTorch. Поняв их, вы перейдете от роли _«исполнителя заклинаний»_ к настоящему _«архитектору нейросетей»_, способному создавать собственные уникальные строительные блоки.
...
> _«Почему я не мог просто использовать обычный `torch.tensor` для весов?»_
...
_Теперь, когда вы умеете ковать собственные «Рунные Камни» и собирать из них «Големов», какой магический механизм вы создадите первым?_
