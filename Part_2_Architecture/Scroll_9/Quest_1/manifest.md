...
Давайте заглянем под капот этого процесса. Мы отправимся в небольшой квест: вручную исполним древний ритуал обучения, чтобы демистифицировать его и раскрыть фундаментальные принципы. Наша цель — превратиться из простого *«пользователя»* этих заклинаний в *«мага, который понимает их душу»*.
...
> *«Почему в ручном методе мы обновляем веса простой формулой, а в автоматическом — используем целый «инструмент» `optimizer.step()`? Разве он не делает то же самое?»*
...
*Зная, что в основе магии лежат простые законы, какой следующий «черный ящик» вы осмелитесь открыть?*
