...
# Мы призываем наш силовой гримуар PyTorch.
import torch
...
# Мы призываем заклинание `Image` из гримуара "Pillow" для открытия изображений.
...
# `time.time()` — это заклинание, которое возвращает текущее "магическое время" (в секундах).
