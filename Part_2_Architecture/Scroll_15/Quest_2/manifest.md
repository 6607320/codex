...
_Теперь, когда вы знаете об этом, взгляните на свой код по-новому. А какие еще параметры «по умолчанию» в вашем коде могут скрывать такой же огромный потенциал для оптимизации?_
