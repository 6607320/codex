...
> _…а что, если в нашем наборе данных миллионы «свитков»? Не займет ли создание первоначального «каталога» с помощью `glob.glob` в заклинании `__init__` слишком много времени и памяти?_
...
_Теперь, когда вы знаете, как создавать собственные конвейеры данных, за какой «невозможный» набор данных вы возьметесь в первую очередь?_
