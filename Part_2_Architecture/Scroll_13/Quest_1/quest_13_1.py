...
# Мы начинаем создание "чертежа" (класса) для нашего нового, эффективного артефакта.
class DepthwiseSeparableConv(nn.Module):
    # Мы определяем заклинание Инициализации. Оно принимает те же параметры, что и обычный `Conv2d`.
    def __init__(self, in_channels, out_channels, kernel_size, padding):
        ...
        self.depthwise = nn.Conv2d(
            ...
            in_channels,
            # Важно: выходных каналов СТОЛЬКО ЖЕ. Каждый "гном" создает свою одну карту.
            in_channels,
        ...
        self.pointwise = nn.Conv2d(
            ...
            in_channels,
            # А на выходе создает нужное нам количество финальных, "сплавленных" карт.
            out_channels,
...
# Мы проводим финальную проверку: убедимся, что оба рудокопа выдают "сплав" одинаковой формы.
