...
transform = transforms.Compose(
    ...
    [
        # Первая "линза": превращает картинку из формата PIL/numpy в Тензор PyTorch.
        transforms.ToTensor(),
...
# Мы устанавливаем "Баланс" между мудростью Магистра и сухими фактами из учебника.
alpha = 0.5
...
for data, target in tqdm(train_loader, desc="Обучение Подмастерья (1 эпоха)"):
    ...
    # Мы используем защитное заклинание `no_grad`, так как Магистр не должен учиться.
    with torch.no_grad():
