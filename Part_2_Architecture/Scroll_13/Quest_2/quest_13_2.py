...
Этот пергамент демонстрирует "Перегонку Знаний" (Knowledge Distillation) —
хитрую магию сжатия моделей. Его главная цель (МАКРО-контекст) — обучить
маленького и быстрого "Голема-Подмастерья" имитировать "мыслительный
процесс" большого и мудрого "Голема-Магистра".

Ритуал состоит из двух актов: сначала мы быстро обучаем "Магистра", а затем
используем его "мягкие" предсказания (soft labels) как дополнительный
учебный материал для "Подмастерья". Ключ к этой магии — составная функция
потерь, которая заставляет "Подмастерья" слушать и "мудрый шепот" Магистра
(distillation loss), и "сухие факты" из учебника (student loss), впитывая
таким образом "интуицию" своего учителя.
"""
