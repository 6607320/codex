# === quest_16_2.py ===
# Имя этого пергамента, хранящего ритуал обучения под надзором "Хронографа".
...
with mlflow.start_run(run_name="Обучение MiniCNN"):
    ...
    # Мы создаем переменные для наших настроек, чтобы было удобно их менять и записывать.
    learning_rate = 0.01
