...
with mlflow.start_run(run_name="Пробный Ритуал"):
    ...
    # Первый аргумент — имя метрики, второй — ее значение, третий (необязательный) — "шаг".
...
print("\nРитуал завершен!")
# Мы даем Магу-Техноманту точную инструкцию, как посмотреть на результаты своей работы.
print(
