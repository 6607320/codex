...
feature_map_visual = cv2.normalize(feature_map, None, 0, 255, cv2.NORM_MINMAX, dtype=cv2.CV_8U)
cv2.imwrite('feature_map.png', feature_map_visual)
print("\nМагия свершилась! 'Карта Признаков' сохранена в 'feature_map.png'.")
print("Открой ее и обрати внимание, как ярко подсвечена именно та область, где в оригинале была вертикальная линия.")