...
print("Открой картинку. Ты видишь 8 разных 'Карт Внимания' - по одной от каждого 'мудреца'.")
print("Они все разные! Это потому, что каждый мудрец 'смотрит' на мир через свою призму.")
print("- Мудрец #1 мог научиться находить связи 'кто-кому'. Он бы показал яркую связь между 'король' и 'принцу'.")
print("- Мудрец #2 мог научиться находить глаголы. Он бы 'смотрел' только на слово 'дал'.")
print("- Мудрец #3 мог научиться связывать прилагательные с существительными. Он бы 'смотрел' от 'Старый' на 'король'.")
print("Вместе, выводы всех восьми мудрецов дают невероятно богатое и полное понимание предложения.")