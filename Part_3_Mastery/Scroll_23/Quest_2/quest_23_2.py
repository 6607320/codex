...
if __name__ == "__main__":
    ...
    emotion_altar = gr.Interface(
        ...
        # 'outputs' - окно для вывода будет специальным компонентом 'Label' для отображения классов.
    ...
    vision_altar = gr.Interface(
        ...
        fn=classify_image,
        # 'inputs' - окно для ввода будет специальным компонентом 'Image' для загрузки картинок.
        inputs=gr.Image(type="pil", label="Изображение для анализа"),
        # 'outputs' - окно для вывода будет 'Label', которое красиво покажет топ-3 класса.
    ...
    # 'gr.TabbedInterface' - могущественное заклинание, которое "склеивает" интерфейсы во вкладки.
