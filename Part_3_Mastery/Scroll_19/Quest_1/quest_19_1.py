...
def transcribe_audio(audio_path):
    ...
    del processor
    # Мы принудительно очищаем Кристалл Маны (GPU VRAM) для следующего Голема.
    torch.cuda.empty_cache()
    # Мы сообщаем об успешном изгнании.
    print("Голем-Писец изгнан. Кристалл Маны (GPU VRAM) очищен.")
...
def classify_intent(text):
    ...
    print("Голем-Толкователь изгнан. Кристалл Маны (GPU VRAM) снова очищен.")
