# === quest_17_1.py ===
# Имя этого пергамента, хранящего ритуал создания нашего первого "Амулета".
...
# Мы призываем чертеж `BaseModel` для описания данных, которые будут приходить в портал.
