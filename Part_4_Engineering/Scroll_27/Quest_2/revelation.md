...
4. Git встречает файл models/golem_mind.pth.dvc. Этот файл не подпадает под правила игнорирования. Git помечает его как _Untracked_ (или _Modified_, если это обновление).
