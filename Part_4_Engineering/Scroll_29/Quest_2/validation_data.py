...
# Мы начинаем ритуал сотворения нашего "Кристалла Истины" (`VALIDATION_SET`) — это священный перечень, хранящий неоспоримые эталоны.
VALIDATION_SET = [
...
# Закрывающая скобка `]` — это руна, которая "запечатывает" наш "Кристалл Истины", завершая его сотворение.
]
