...
_Оставлять сборочные инструменты в production-образе — это как если бы хирург оставлял инструменты внутри пациента._ Теперь, когда вы видите, насколько просто навести порядок, что вы сделаете, чтобы поднять стандарты своего мастерства?
