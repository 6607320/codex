...
w = torch.tensor([0.0], requires_grad=False) # requires_grad=False, так как мы считаем сами
...
for epoch in range(15):
    ...
    # --- Отчет о прогрессе ---
    print(f"Эпоха {epoch + 1}: Предсказание={y_predicted.item():.4f}, Ошибка={loss.item():.4f}, w={w.item():.4f}, b={b.item():.4f}")
